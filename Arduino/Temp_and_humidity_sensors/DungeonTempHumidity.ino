//Dungeon Temperature and humidity sensor
...
const char* temperature_topic = "home/esp32/temperature/dungeon";
const char* humidity_topic = "home/esp32/humidity/dungeon";
